        ...
        if (req.url.startsWith("/blog/")) {
            ...
            switch (viewName) {
                case "admin-dashboard":
                    ...
                    break;
                case "admin-page-manager":
                    data = await dataService.getContentByType('page');
                    break;
                case "admin-category-manager":
                    data = await dataService.getContentByType('category');
                    break;
                case "admin-blog-manager":
                ...
                case "admin-theme-settings":
                    ...
                    break;
                case "admin-site-settings-colors":
                    ...
                    break;
                case "admin-site-settings-typography":
                    data = await dataService.getContentTopOne("site-settings");
                    data.editForm = await formService.getForm("site-settings", data);
                    break;
                case "admin-users":
